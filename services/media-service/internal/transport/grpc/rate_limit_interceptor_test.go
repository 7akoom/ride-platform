...
func TestRateLimitInterceptor_AllowsUpToBurstThenRejects(t *testing.T) {
	...
	info := &googlegrpc.UnaryServerInfo{FullMethod: "/ride.media.v1.MediaService/GetMedia"}
...
func TestRateLimitInterceptor_ExemptsHealthCheck(t *testing.T) {
	...
	ordinaryInfo := &googlegrpc.UnaryServerInfo{FullMethod: "/ride.media.v1.MediaService/GetMedia"}
