...
// on. This service is a machine caller of trip/location/driver/wallet,
// not an end user acting on its own behalf, so it authenticates as a
// service rather than forwarding a token it doesn't have.
